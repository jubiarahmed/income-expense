...
const expenseStyles: Record<ExpenseCategory, CategoryStyle> = {
...
const incomeStyles: Record<IncomeCategory, CategoryStyle> = {
...
export function getExpenseCategoryStyle(category: ExpenseCategory): CategoryStyle {
  return expenseStyles[category] ?? expenseStyles.Other;
}

export function getIncomeCategoryStyle(category: IncomeCategory): CategoryStyle {
  return incomeStyles[category] ?? incomeStyles.Others;
}
